...
CREATE USER 'Weight'@'%' IDENTIFIED BY '123';
GRANT ALL PRIVILEGES ON weight.* TO 'Weight'@'%' WITH GRANT OPTION;
GRANT ALL PRIVILEGES ON weight.* TO 'provider'@'%' WITH GRANT OPTION;
